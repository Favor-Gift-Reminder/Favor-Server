...
public class UserRequestDto {
    ...
    @ApiModelProperty(position = 3, required = true, value = "이름", example = "페이버")
    private String name;

    @ApiModelProperty(position = 4, required = true, value = "아이디", example = "Favor")
    private String userId;

    @ApiModelProperty(position = 5, required = true, value = "권한", example = "USER")
    private Role role;
